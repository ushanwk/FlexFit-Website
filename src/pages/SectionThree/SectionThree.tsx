...
export class SectionThree extends Component {
    render() {
        return (
            <>
                <section className="bg-gray-100 mt-24 pb-32 flex text-center flex-col pl-64 pr-64">

                    <h1 className="text-[30px] font-medium mt-24">Our <span className="text-primary">Special </span>Sessions
                    </h1>
